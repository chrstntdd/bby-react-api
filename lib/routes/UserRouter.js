...
const sendEmailAsync = emailData => new Promise((resolve, reject) => {
    transporter.sendMail(emailData, err => {
        err ? reject(err) : resolve(emailData);
    });
});
const verifySMTP = () => new Promise((resolve, reject) => {
...
class UserRouter {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existingUser) {
                ...
                if (process.env.NODE_ENV === 'test') {
                    ...
                    try {
                        yield verifySMTP();
                        yield sendEmailAsync(emailData);
                        res.status(201).json({
    ...
    init() {
        ...
        this.router.post('/verify-email', exports.asyncMiddleware(this.verifyEmail));
        this.router.post('/forgot-password', exports.asyncMiddleware(this.forgotPassword));
        this.router.post('/reset-password', exports.asyncMiddleware(this.resetPassword));
